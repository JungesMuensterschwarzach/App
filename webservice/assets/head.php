...
<meta http-equiv="Content-Security-Policy"
    content="
      default-src 'self' localhost localhost:3000 *.junges-muensterschwarzach.roth-familie.eu *.jma.local; 
      script-src  'self' 'unsafe-inline' blob: localhost localhost:3000 *.junges-muensterschwarzach.roth-familie.eu *.jma.local *.tinymce.com *.tiny.cloud *.mapbox.com; 
      connect-src 'self' blob: localhost localhost:3000 *.junges-muensterschwarzach.roth-familie.eu *.jma.local *.tinymce.com *.tiny.cloud *.mapbox.com; 
      img-src     'self' blob: data: localhost localhost:3000 *.junges-muensterschwarzach.roth-familie.eu *.jma.local *.tinymce.com *.tiny.cloud *.ytimg.com *.tenor.com *.mapbox.com; 
      frame-src   'self' localhost localhost:3000 *.junges-muensterschwarzach.roth-familie.eu *.jma.local *.youtube.com;
      media-src   'self' localhost localhost:3000 *.junges-muensterschwarzach.roth-familie.eu *.jma.local *.youtube.com; 
      style-src   'self' 'unsafe-inline' localhost localhost:3000 *.junges-muensterschwarzach.roth-familie.eu *.jma.local *.tinymce.com *.tiny.cloud fonts.googleapis.com *.mapbox.com; 
      font-src    'self' localhost localhost:3000 *.junges-muensterschwarzach.roth-familie.eu *.jma.local *.tinymce.com *.tiny.cloud fonts.gstatic.com;"
/>
<!-- JMA -->
